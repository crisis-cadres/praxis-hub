...
- A cadre that depends on grocery stores is one bad harvest, shipping delay, or economic shock away from hunger.
- Prioritize calorie-dense staples like potatoes, beans, and grains for immediate survival needs.
...
**[Start a discussion](https://github.com/crisis-cadres/praxis-hub/issues/new?title=Food%20Production%20and%20Security)** · [View discussions](https://github.com/crisis-cadres/praxis-hub/issues) · [Edit this page](https://github.com/crisis-cadres/praxis-hub/edit/main/wiki/docs/pillars/production/food-security.md)
