...
- Oversee transportation, storage, and fair distribution, and run tool libraries and skill exchanges so no resource sits idle.

---

**[Start a discussion](https://github.com/crisis-cadres/praxis-hub/issues/new?title=Procurement%20Fundamentals)** · [View discussions](https://github.com/crisis-cadres/praxis-hub/issues) · [Edit this page](https://github.com/crisis-cadres/praxis-hub/edit/main/wiki/docs/pillars/procurement/fundamentals.md)
