...
- Phase Two, the housing rollup: [Procurement](../pillars/procurement/index.md) acquires a property and rents it at cost, with [surplus](../cadres/surplus-recruitment.md) reinvested to pay down principal.
...
- [Surplus housing](../cadres/surplus-recruitment.md) becomes a strategic tool for outreach, offering safe temporary shelter to allies and growing the movement.
...
**[Start a discussion](https://github.com/crisis-cadres/praxis-hub/issues/new?title=Housing)** · [View discussions](https://github.com/crisis-cadres/praxis-hub/issues) · [Edit this page](https://github.com/crisis-cadres/praxis-hub/edit/main/wiki/docs/governance/housing.md)
